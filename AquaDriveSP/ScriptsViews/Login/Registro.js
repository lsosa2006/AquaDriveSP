document.addEventListener("DOMContentLoaded", function () {
    ...
    formRegistro.addEventListener("submit", function (e) {
        ...
        if (tipoCuenta === "cliente" && (!direccion || !regexDireccion.test(direccion))) {
            Swal.fire("Error", "Ingresa una direcciÛn v·lida (mÌnimo 5 caracteres, debe incluir letras, n˙meros y terminar con ', Ciudad'). Ejemplo: Calle 10 #25-30, MedellÌn.", "error");
            return;
        }
